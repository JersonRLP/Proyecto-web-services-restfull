	...
	public void saveUser(Usuario usuario) {
		...
		//asignamos a la conexion y el p.a.
			...
			try {
		        ...
		        // Cerrar recursos en el bloque finally para asegurar su liberaci�n
		        if (cs != null) {
		            try {
		                cs.close();
		            } catch (SQLException e) {
		        ...
		        conex.cerrarConexion(); // M�todo para cerrar la conexi�n en ConectarBD
		    }
	...
	public boolean existCorreo(String correo) {
		 ConectarBD conex = new ConectarBD();
		    ...
		    try {
		        ...
		        String sql = "{call existeCorreo(?)}"; // Aseg�rate de usar el nombre correcto del procedimiento almacenado
